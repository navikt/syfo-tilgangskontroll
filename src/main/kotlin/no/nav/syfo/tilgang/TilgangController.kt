...
import no.nav.syfo.security.OIDCClaim.NAVIDENT
import no.nav.syfo.security.OIDCIssuer.AZURE
import no.nav.syfo.security.OIDCIssuer.VEILEDERAZURE
import no.nav.syfo.security.OIDCUtil.getSubjectFromAzureOIDCToken
import no.nav.syfo.security.OIDCUtil.getTokenFromAzureOIDCToken
