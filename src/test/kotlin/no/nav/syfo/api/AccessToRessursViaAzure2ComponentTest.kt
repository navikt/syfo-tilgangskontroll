...
class AccessToRessursViaAzure2ComponentTest {
    ...
    @Test
    fun `access to Kode6-personident granted to veileder with Kode6 group access`() {
    ...
    @Test
    fun `access to Kode6-personident granted for smregistrering and NAVIdent with Kode6 group access`() {
        loggUtAlle(oidcRequestContextHolder)
    ...
    @Test
    fun `access to Kode7-personident granted with KODE7 group`() {
    ...
    @Test
    fun `access to EgenAnsatt-personident granted with egenansatt group`() {
